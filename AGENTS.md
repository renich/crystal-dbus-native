...
## Project Domain: Native DBus integration for Crystal

### Domain-Specific Knowledge
- Uses SASL ANONYMOUS/EXTERNAL authentication pipelines.
- Strictly relies on file descriptor passing (FD passing) via UNIX sockets.
- Signature validation is rigorously typed to prevent DBus malformed packet attacks.
